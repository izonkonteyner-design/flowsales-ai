...
export default async function GrowthControlPage() {
  ...
  const data = context.mode === "live" ? await getGrowthControlCenter(context.organization.id) : { sla: [], workload: [], duplicates: [], hygiene: { total: 0, needsAttention: 0, rows: [] }, growth: [], forecast: { openPipelineValue: 0, weightedPipelineValue: 0, forecastConfidence: 0, stageCounts: {}, count: 0 } };
