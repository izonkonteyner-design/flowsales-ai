...
export default async function IntegrationsPage() {
  ...
  return <div className="mx-auto max-w-6xl">
    ...
    {!isDemo && canManage && anyMetaConfigured && <section className="mb-6 rounded-2xl border border-emerald-200/70 bg-emerald-50/70 p-5 dark:border-emerald-800/40 dark:bg-emerald-950/15" aria-label="Meta channel self-service onboarding">
      <div className="flex flex-wrap items-center justify-between gap-3"><div><h2 className="font-semibold text-emerald-900 dark:text-emerald-200">Meta channels — self-service setup</h2><p className="mt-1 text-sm text-emerald-800/80 dark:text-emerald-300/80">Connect WhatsApp, Instagram and Facebook without manually pasting access tokens, WABA IDs, Page IDs or Instagram account IDs.</p><p className="mt-1 text-xs text-emerald-700/80 dark:text-emerald-400/80">WhatsApp self-service setup continues through Meta Embedded Signup; Instagram and Facebook use Meta OAuth account selection.</p></div><span className="rounded-full bg-emerald-600 px-3 py-1 text-xs font-semibold text-white">{connectedMetaChannels}/3 connected</span></div>
