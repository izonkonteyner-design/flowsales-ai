    ...
    <div className="border-b border-slate-800/80 bg-violet-950/20 px-6 py-2.5 text-xs">
      ...
      {suggestion && <div className="mt-2 rounded-xl border border-violet-800/50 bg-slate-950/80 p-3">
        ...
        <div className="mt-2 flex items-center justify-end gap-2">
          <button type="button" onClick={() => setSuggestion(null)} className="inline-flex items-center gap-1 rounded-lg px-2 py-1 text-slate-400 hover:bg-slate-800"><X className="h-3 w-3" /> Dismiss</button>
