...
export const QUOTE_STATUSES: Array<{ value: QuoteStatus; label: string }> = [
  { value: "draft", label: "Draft" }, { value: "sent", label: "Sent" }, { value: "viewed", label: "Viewed" },
  { value: "accepted", label: "Accepted" }, { value: "rejected", label: "Rejected" }, { value: "expired", label: "Expired" }, { value: "cancelled", label: "Cancelled" },
];

export const CURRENCY_CODES: Array<{ value: CurrencyCode; label: string }> = [
  { value: "TRY", label: "TRY" }, { value: "USD", label: "USD" }, { value: "EUR", label: "EUR" },
];

export const QUOTE_DISCOUNT_TYPES: Array<{ value: QuoteDiscountType; label: string }> = [
...
export const SUBSCRIPTION_PLANS = [
  { id: "starter", name: "Starter", seatLimit: 3, aiMessageLimit: 100, features: ["Leads", "Quotes", "Tasks"] },
  { id: "pro", name: "Pro", seatLimit: 10, aiMessageLimit: 500, features: ["Reports", "Workspace settings", "AI drafts"] },
  { id: "business", name: "Business", seatLimit: 50, aiMessageLimit: 2000, features: ["Role controls", "Advanced analytics", "Priority support"] },
] as const;
