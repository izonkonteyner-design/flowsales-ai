...
const common = {
  tr: {
    ...
    readOnlyPreview: "Salt okunur önizleme",
    liveWorkspace: "Canlı çalışma alanı",
    aiRevenueWorkspace: "Yapay zekâ satış çalışma alanı",
    aiUsage: "YZ kullanımı",
    view: "Görüntüle",
    viewAccount: "Hesabı görüntüle",
    searchPlaceholder: "Potansiyel müşteri, müşteri, teklif, ürün ara...",
    search: "Ara",
    aiCommand: "YZ komutu",
  ...
  en: {
    ...
    aiRevenueWorkspace: "AI revenue workspace",
    aiUsage: "AI usage",
    view: "View",
    viewAccount: "View account",
    searchPlaceholder: "Search leads, customers, quotes, products...",
    search: "Search",
...
export function t(locale: Locale, key: CommonTranslationKey): string {
  return common[locale][key] ?? common.tr[key];
}
...
export function navLabel(locale: Locale, label: string): string {
  return navigationLabels[locale][label] ?? label;
}
