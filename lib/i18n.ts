...
const common = {
  tr: {
    ...
    searchPlaceholder: "Potansiyel müşteri, müşteri, teklif, ürün ara...", search: "Ara", aiCommand: "YZ komutu",
  ...
  en: {
    ...
    searchPlaceholder: "Search leads, customers, quotes, products...", search: "Search", aiCommand: "AI command",
...
export const navigationLabels: Record<Locale, Record<string, string>> = {
  tr: {
    ...
    AI: "Yapay Zekâ", "Sales Cockpit": "Satış Kokpiti", "Revenue Intelligence": "Gelir Zekâsı", "AI History": "YZ Geçmişi",
