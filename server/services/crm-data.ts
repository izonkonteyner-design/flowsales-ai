...
export const demoOrganization = {
  ...
  secondary_phone: "+90 533 000 0000",
  address_line_1: "Demo Business Park, Unit 12",
  address_line_2: "Istanbul Technology District",
  district: "Sariyer",
  city: "Istanbul",
  postal_code: "34396",
  country: "Turkey",
  ...
  default_tax_rate: 20,
  default_payment_terms: "50% upfront, balance before delivery",
  default_delivery_terms: "Delivery in 21 days",
  default_quote_notes: "Demo workspace quotes use sample commercial terms.",
  default_quote_validity_days: 30,
  quote_footer_text: "Thank you for choosing FlowSales AI Demo Workspace.",
  signature_name: "Selin Kaya",
  signature_title: "Managing Director",
  company_slogan: "Premium modular sales automation for fast-moving teams.",
};
